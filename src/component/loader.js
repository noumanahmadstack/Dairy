        ...
        return (
            <View style={styles.container}>
                <View style={{ width: dim, height: dim }}>
                    <Animated.View style={{ ...styles.item, transform: [{ translateX: left1 }, { translateY: top1 }, { rotate: angleValue }] }} />
                    <Animated.View style={{ ...styles.item, transform: [{ translateX: left2 }, { translateY: top2 }, { rotate: angleValue }] }} />
                    <Animated.View style={{ ...styles.item, transform: [{ translateX: left3 }, { translateY: top3 }, { rotate: angleValue }] }} />
                    <Animated.View style={{ ...styles.item, transform: [{ translateX: left4 }, { translateY: top4 }, { rotate: angleValue }] }} />
                </View>
            </View>
        )
    }
...
const styles = StyleSheet.create({
    ...
    item: { width: size, height: size, backgroundColor: '#fff', position: 'absolute' }
})